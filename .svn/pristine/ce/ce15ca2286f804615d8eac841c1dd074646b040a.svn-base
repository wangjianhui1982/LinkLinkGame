...
export default class NewClass extends BaseComponent {
    ...
    protected onLoad(): void {
        ...
        this.EventMgr.on(this.EventMgr.Wzhcq_EVENT_NAMES.Wzhcq_FEEDBACKBUTTON, this.Wzhcq_closeUI, this);
    }
    ...
    initData() {
        ...
        Utils.getInstance.is_clickSetting = 1;

        Utils.getInstance.createFeedbackButton(this.Wzhcq_feedbackNode);

        let Wzhcq_version2 = Utils.getInstance.Wzhcq_getItem(Wzhcq_StorageName.Wzhcq_version2);

        this.Wzhcq_version2.string = Wzhcq_version2;
